...
describe('Testa as funções da pasta middleware', () => {
  ...
  it('Testa se o retorno da função tokenValidation tem o retorno esperado caso não seja fornecido um token válido', async () => {
  ...
  it('Testa se o retorno da função tokenValidation tem o retorno esperado caso não seja fornecido um token decodificado válido', async () => {
    req.headers = { authorization: 'anyToken'};
  ...
  it('Testa se o retorno da função tokenValidation tem o retorno esperado caso token seja váido', async () => {
    req.headers = { authorization: 'anyToken'};
